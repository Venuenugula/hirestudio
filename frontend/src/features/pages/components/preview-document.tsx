...
export function PreviewDocument({
  ...
  return (
    ...
    >
      {visibleSections.length === 0 && jobs.length === 0 ? (
...
function PreviewSection({
  ...
  if (section.type === "hero") {
    return (
      <section className="px-6 py-14 sm:px-8 sm:py-16 md:px-10 md:py-20">
  ...
  if (section.type === "about") {
    return (
      <section className="border-t border-black/10 px-6 py-12 sm:px-8 md:px-10">
...
function CtaPreviewSection({ section }: { section: CtaSection }) {
  return (
    <section className="border-t border-black/10 px-6 py-14 sm:px-8 md:px-10">
